 ...
 <div class="formBox">
    <div id="setting-profile" class="setting-wrap setting-profile">
        ...
        <div class="common-title">
            ...
            <img alt=""  src="images/lv_icon6.jpg" class="lv_icon_note">
            	编辑&nbsp;&nbsp;&nbsp;&nbsp;</a>
        </div>
        <div class="line"></div>
        <div class="info-wapper">
         <div class="info-box clearfix">
                <label class="pull-left">昵称</label><div id="nickName" class="pull-left"></div>
            </div>
            <div class="info-box clearfix">
                <label class="pull-left">职位</label><div id="position" class="pull-left">
 </div>
            </div>
            <div class="info-box clearfix">
                <label class="pull-left">城市</label>
                <div class="pull-left" id="loc"></div>
            </div>
            <div class="info-box clearfix">
                <label class="pull-left">性别</label><div id="sex" class="pull-left">
                <%-- <%=request.getParameter("sex")==null?"未设置":request.getParameter("sex")%> --%></div>
            </div>
            <div class="info-box clearfix">
                <label class="pull-left">个性签名</label><div id="sig" class="pull-left">
...
$(function(){
	...
	$("#position").html(localStorage.position);
	$("#loc").html(localStorage.location);
	$("#sex").html(localStorage.sex);
	$("#sig").html(localStorage.signature);

})
   //编辑个人信息
	$(document).on('click', '#gy_selfinfo', function() {
		 layer.open({ 
	        type : 2,
